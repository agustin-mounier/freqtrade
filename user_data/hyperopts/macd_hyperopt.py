...
class MACD_OPT(IHyperOpt):
    ...
    def indicator_space() -> List[Dimension]:
        ...
        return [
            ...
            Categorical([True], name='rsi-enabled'),
            Categorical(['macd_cross_signal'], name='trigger')
        ]
    ...
    def sell_indicator_space() -> List[Dimension]:
        ...
        return [
            ...
            Categorical([True], name='sell-rsi-enabled'),
            Categorical(['sell-macd_cross_signal'], name='sell-trigger')
        ]
